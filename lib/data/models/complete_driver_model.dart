...
CompleteDriverModel CompleteDriverModelFromJson(String str) => CompleteDriverModel.fromJson(json.decode(str));

String CompleteDriverModelToJson(CompleteDriverModel data) => json.encode(data.toJson());
...
class CompleteDriverModel {
    ...
    factory CompleteDriverModel.fromJson(Map<String, dynamic> json) => CompleteDriverModel(
